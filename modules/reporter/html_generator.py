...
<body>
    ...
    <div class="container">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="summary-label">Unique Secrets</div>
                <div class="summary-sublabel">{{ total_raw_findings }} total occurrences ({{ statistics.deduplication_ratio }} deduplication)</div>
            </div>
    ...
    <div class="footer">
        ...
        <p>{{ total_unique_secrets }} unique secrets found across {{ total_raw_findings }} occurrences</p>
    </div>
